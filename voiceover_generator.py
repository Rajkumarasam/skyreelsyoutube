...
# Check if Nari Labs Dia is available and configured
...
def generate_voiceover(script: str) -> str:
    """
    Generate a voiceover MP3/WAV file for the given script.
    Uses Nari Labs Dia if available and configured, otherwise falls back to Edge-TTS.
    """
    os.makedirs("assets/audio", exist_ok=True)
    out_wav = os.path.join("assets/audio", "voiceover_dia.wav")
